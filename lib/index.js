...
exports.createServices = exports.createMethod = exports.axiosConfig = void 0;
...
var request = function request(method, url, data, options) {
  var result = (0, _util.format)(url, data);

  for (var _len = arguments.length, rest = new Array(_len > 4 ? _len - 4 : 0), _key = 4; _key < _len; _key++) {
    rest[_key - 4] = arguments[_key];
  }

  return methods[method].apply(methods, [result.url, result.data, options].concat(rest));
};
/**
...
var createServices = function createServices(api, mockData) {
  ...
  if ((0, _util.isObject)(api)) {
    ...
    var isMock = (0, _util.isObject)(mockData);
    names.forEach(function (name) {
      var _api$name$split = api[name].split(' '),
      ...
      if (process.env.NODE_ENV !== 'production' && isMock && !!(mockResponseData = mockData[name])) {
        method = 'MOCK-REQUEST';
      } else {
